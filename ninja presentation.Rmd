...
```{r q1 females, echo=FALSE, fig.align="center", fig.width=10, fig.height=5, warning=FALSE}
...
* Overall increasing trend for every country

* Malta, Austria and Cyprus display the most irregular trends
...
```{r q1 males, echo=FALSE, fig.align="center", fig.width=10, fig.height=5, warning=FALSE}
...
* Overall values for mortality are higher than those of females.
...
```{r q2 females, echo=FALSE, fig.align="center", fig.width=10, fig.height=5, warning=FALSE}
...
* The first age groups show very small mortality rate

* Older population is more susceptible to die due to this kind of cancer 

---
class: sixth-slide, center
## Mortality rates by age groups between countries in 2016

```{r q2 males, echo=FALSE, fig.align="center", fig.width=10, fig.height=5, warning=FALSE}
...
* Mortality rate is higher for the Male population than for Female population
...
```{r female population.ex3, echo=FALSE, fig.align="center", fig.width=10, fig.height=5, warning=FALSE}
# For the female population
data.diff.F %>%
 ...
 * Portugal, European Union and Germany whit a stabilization along the years
 
 * Cyprus, Austria and Malta whit a very irregular trend trought the years (Depois podemos complementar dizendo que cada um destes aumentou ou diminuiu nos ultimos anos, mas isto não precisa de estar escrito)

---
class: ninth-slide, center

## Changes in percentage terms between 2011 and 2016 
```{r Male population.ex3, echo=FALSE, fig.align="center", fig.width=10, fig.height=5, warning=FALSE}
# For the male population
data.diff.M %>%
  ggplot(aes(Year, per, group=Country, colour =Country))+
  geom_point(size=3) +
 ...
 * A general stabilization across the years except for Malta (Which has a 75% increase in the mortality rate, from 2011 to 2016 )
