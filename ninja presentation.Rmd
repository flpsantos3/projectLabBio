...
* Overall **increasing trend** for every country & values for mortality for men are **higher than** those of **females**.
...
---
class: seventh-slide, center

## Changes in percentage terms between 2011 and 2016 

```{r female population.ex3, echo=FALSE, fig.align="center", fig.width=11, fig.height=6, warning=FALSE}
# For the female population
 ...
 * **Portugal, European Union and Germany** display **stable** values along the years & **Cyprus, Austria and Malta** show a very **irregular trend** throughout the years
