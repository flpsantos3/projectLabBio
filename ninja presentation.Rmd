...
---
class: tenth-slide, middle

.center[
## Mortality rate per sex over the years, for all age groups
]
```{r ggA2, echo=FALSE,  fig.align="center", fig.width=11, fig.height=6, warning=FALSE}
