...
packages <- c("ggplot2", "here", "data.table", "unglue", "magrittr", "kableExtra")
...
Also, there are some inherint limitations to the data in the sense that, the chenge restitered in the mortality rate, from year to year, may be duo to:
  * Improvements of the detection of this kind of cancer
  * An increase in the portion of the population being tested and diagnosed
Even differences between countries may suffer from this limitations

# *Data Tidying* 
## `Cancer Data`:

```{r cancerData, results= FALSE}
# Colunas certas nos dado
...
## *Interpretation*
  ...
  * Contrary to the other countrys (which always increase), Malta mortality rate just oscilates a lot between the classes 55-60 and 85, where it ends with a 0 mortality rate
  * The firsts Age classes (until the classe 35-39) shown zero to very few mortality rate for this type of cancer on the Female population
  * The trend observed here is that older population (From the age of 50 foward) is more susceptible to die due to this kind of cancer and, in this danger group, in general, Germany, Austria, Portugal, Malta and Cyprus have a lower mortality rate when compared to the mortatity rate of the European Union
    + Malta only have a higher mortatlity rate than the European Union in the classes of 60-64 and 80-84
    + Cyprus only have a higher mortality rate than the European Union in the classes of 50-54, 65-69, 80-84 and 85
...
## *Interpretation*
  ...
  * As well as with the female population, the firsts Age classes (until the class 40-44) shown zero to very few mortality rate for this type of cancer on the Female population
  * Again, trend observed here is that older population (From the age of 50 foward) is more susceptible to die due to this kind of cancer and, in this danger group, in general, Germany, Austria, Portugal and Cyprus have a lower mortality rate when compared to the mortatity rate of the European Union, while Malta as ganneraly a higher mortality rate than the European Union
    + However, Portugal as a higher moratlity rate, when compared to the European Union, between the age classes of 50-54 to 65-69
    + Austria also shows a higher moralitu rate than European Union between the age classes of 60-64 to 75-79 
    + Inversily, Malta only shows a mortality rate lower than the European Union in the age classes of 60-64 and 65-69
  * In general, the mortality rate of this type of cancer is higher in the Male population than on the Female population, at least, in the conuntrys here analyse
...
The country that changed the most, for the mortality rate for the Female popualtion, since 2011 to 2016, was Cyprus with an increase of 18.9%
...
# This one maybe for the slides

all <- rbind(diff.Females,diff.Males)
all %>%
  kable(align = "cccccc") %>%
  kable_styling() %>%
  pack_rows("Female Population", 1, 5) %>%
  pack_rows("Male population" , 6, 10) %>%
  column_spec(1, bold = T)
...
The conuntry that changed the most, for the mortality rate for the Male population, since 2011 to 2016, was Malta with an increase of 71.5% 
