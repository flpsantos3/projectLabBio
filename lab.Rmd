...
By taking a quick look at the data sets we can observe that there are some missing data from some countries and for the year 2017, in specific, there are no data regarding the cancer for the countries of Portugal and Malta.

Also, there are some inherent limitations to the data in the sense that, the change registered in the mortality rate, from year to year, may be duo to:
...
The country that changed the most, for the mortality rate for the Male population, since 2011 to 2016, was Malta with an increase of 71.5% 
